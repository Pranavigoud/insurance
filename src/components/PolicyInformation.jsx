        ...
        <div className="bg-gray-100 rounded-2xl p-8 md:p-12">
          ...
          <div className="border-t border-gray-300 pt-6">
            ...
            >
              ...
              <span className={`shrink-0 text-gray-500 text-xl transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
                ▼
              </span>
            </button>
            ...
            {isExpanded && (
              <div className="mt-6 pt-6 border-t border-gray-300">
                ...
                <ul className="text-gray-600 text-sm md:text-base leading-relaxed space-y-3">
